...
import { Compass, Target, Code, Rocket } from 'lucide-react';

const steps = [
  {
    number: '01',
    title: 'Diagnóstico de Percepção',
    description: 'Analisamos posicionamento, autoridade visual e gargalos invisíveis.',
    icon: Compass,
  },
  {
    number: '02',
    title: 'Reestruturação Estratégica',
    description: 'Reposicionamento de identidade, site e comunicação.',
    icon: Target,
  },
  {
    number: '03',
    title: 'Implantação',
    description: 'Produção de branding, ambiente digital e criativos de performance.',
    icon: Code,
  },
  {
    number: '04',
    title: 'Escala e Otimização',
    description: 'Ajustes orientados por dados para aumentar impacto e conversão.',
    icon: Rocket,
  },
];
      ...
      <div className="container-wide">
        ...
        <div className="mb-24 md:mb-32">
          ...
          >
            ...
            <span className="text-sm font-mono text-muted-foreground tracking-wider">PROCESSO</span>
          </motion.div>

          <AnimatedLine>
            <h2 className="font-syne font-bold text-5xl md:text-7xl max-w-4xl tracking-tight leading-[0.9]">
              Do Diagnóstico <span className="text-accent">à Dominação.</span>
            </h2>
          </AnimatedLine>
        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 min-h-[400px]">
                    ...
                    <div className="hidden md:block md:col-span-4 bg-secondary/5 relative overflow-hidden border-l border-border">
                      ...
                      <div className="absolute inset-0 opacity-20">
                        <div
                          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] border-[20px] border-foreground/5 rounded-full
