...
export const clientPortals: ClientPortal[] = [
  {
    ...
    manual: [
      ...
      'Redução e Legibilidade: O símbolo foi otimizado para manter a clareza mesmo em escalas reduzidas. As linhas da torre possuem espessura calculada para não "fecharem" em aplicações pequenas, garantindo uma identidade impecável desde um cartão de visitas até um outdoor.',
    ],
    aplicacoes: [
